...
const Testimonial = () => {
  return (
     ...
     <div className="flex items-center gap-2 text-sm text-indigo-500 bg-blue-400/10 border border-indigo-200 rounded-full px-4 py-1">
            <BookUserIcon className=" size-4.5 stroke-indigo-500" />
            <span>Testimonials</span>
        </div>
        <Title title="What our partners say" description="this is some opingnons of our customers and partners" />
            ...
            <div className="flex flex-wrap justify-center gap-5 mt-16 text-left">
                <div className="w-80 flex flex-col items-start border border-gray-200 p-5 rounded-lg bg-white">
                    ...
                    <div className="flex items-center gap-3 mt-4">
                        ...
                        <div>
                            <h2 className="text-lg text-slate-400 font-medium">Donald Jackman</h2>
                ...
                <div className="w-80 flex flex-col items-start border border-gray-200 p-5 rounded-lg bg-white">
                    ...
                    <div className="flex items-center gap-3 mt-4">
                        ...
                        <div>
                            <h2 className="text-lg text-slate-400 font-medium">Richard Nelson</h2>
                ...
                <div className="w-80 flex flex-col items-start border border-gray-200 p-5 rounded-lg bg-white">
                    ...
                    <div className="flex items-center gap-3 mt-4">
                        ...
                        <div>
                            <h2 className="text-lg text-slate-400 font-medium">James Washington</h2>
