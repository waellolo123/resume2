      ...
      <>
            <div className="min-h-screen pb-20">
                ...
                <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
                    <Link to="/">
                     <h1 className="text-3xl md:text-4xl text-indigo-500 font-semibold">Buildif<span className="text-slate-400">y.</span></h1>
                    </Link>
                    <div className="hidden md:flex items-center gap-8 transition duration-500 text-slate-800">
                        ...
                        <Link href="#cta" className="hover:text-indigo-600 transition">Contact</Link>
                    </div>
                ...
                <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
                    ...
                    {/* Headline + CTA */}
                    <h2 className="text-5xl text-slate-400 md:text-6xl font-semibold max-w-5xl text-center mt-4 md:leading-[70px]">
                        Build Your Resume Easely <span className=" text-indigo-500">With Minimum</span> Efforts.
                    </h2>

                    <p className="max-w-md text-center text-base my-7">Your resume builder is facilitate your process to create professional resume</p>
