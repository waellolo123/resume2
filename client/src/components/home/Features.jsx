...
const Features = () => {
  ...
  return (
    <div id="features" className="flex flex-col items-center my-10 scroll-mt-12">
     ...
     <div className="flex items-center gap-2 text-sm text-indigo-500 bg-blue-400/10 border border-indigo-200 rounded-full px-4 py-1">
            <Zap width={16} />
            <span>Very fast and simple</span>
        </div>

        <Title title="Create Your Resume" description="very simple and fast process, you can build a professional resume that allows you to land good job." />
