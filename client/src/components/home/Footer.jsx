...
const Footer = () => {
  return (
    <footer className="px-6 md:px-16 mt-28 lg:px-24 xl:px-32 w-full text-sm text-slate-500 bg-white pt-10">
                ...
                <p className="py-4 text-center border-t mt-6 border-slate-200">
                    Copyright 2025 © <a href="https://prebuiltui.com">Buildify</a> All Right Reserved.
                </p>
            </footer>
  )
}
